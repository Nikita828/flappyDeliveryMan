...
// Phaser доступен глобально из CDN
import { initYSDK, showFullscreenAd, submitScore } from "./ysdk.js";
...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.bestText = this.add
      .text(WIDTH / 2, 78, "Рекорд: " + this.bestScore, {
        fontFamily: "Arial",
        fontSize: "16px",
        color: "#ffffffcc",
        stroke: "#00000066",
    ...
    this.hintText = this.add
      .text(WIDTH / 2, HEIGHT / 2 + 80, "Нажми чтобы начать", {
        fontFamily: "Arial",
        fontSize: "22px",
        color: "#ffffff",
        stroke: "#000000",
  ...
  die() {
    ...
    this.bestText.setText("Рекорд: " + this.bestScore);
    this.scoreText.setVisible(false);

    this.panelScoreText.setText("Счёт: " + this.score);
    this.panelBestText.setText("Рекорд: " + this.bestScore);
...
async function startGame() {
  try {
    ...
    // Убираем лишние логи - SDK сам напишет если инициализирован
  } catch (e) {
    // Тихо продолжаем без SDK
  }
